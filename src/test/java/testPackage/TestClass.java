...
public class TestClass extends TestBase{
	...
	public void testSuccessfullyOpningForTheUsersPage()
	{
...
public void testSuccessfullyAddingStudent()
{
	...
	newstudentObject.FillTheStudentCodetextBox("25");
	newstudentObject.FillFirstNametextBox("islam");
	newstudentObject.FillLastNameTextButton("heshmat");
	newstudentObject.FilluserNameTextButton("Heshnhmat@endj");
	newstudentObject.FillGradeDropDown();
	newstudentObject.SelectClassDropDown();
	newstudentObject.ClickOnCreateButton();
}
